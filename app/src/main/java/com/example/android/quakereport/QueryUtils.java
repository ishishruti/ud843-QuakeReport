...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link CustomAdapter} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<CustomAdapter> extractEarthquakes() {

        ArrayList<CustomAdapter> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for(int i=0;i<features.length();i++){
                ...
                earthquakes.add(new CustomAdapter(mag,place,time));
            }
